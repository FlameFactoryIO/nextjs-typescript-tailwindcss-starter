...
const CampaignBlock = ({
  ...
  return (
    <Block className="flex flex-col">
      <div
        className={`flex flex-col  t:justify-between ${
          !alwaysVertical && "t:flex-row"
        }`}
      >
        <div className="flex">
      ...
      <div
        className={`flex flex-col t:gap-30px mt-12px ${
          !alwaysVertical && "t:flex-row"
        }`}
      >
        ...
        <div className={`flex flex-col ${!alwaysVertical && "t:w-360px"} `}>
          <div className= "mt-30px text-12px leading-16px font-light">Raising for</div>
          <div className="text-13px leading-16px font-bold mt-10px">
            {nonprofit.currentCampaign.title}
          </div>
          {alwaysVertical ? (
            <div
              className={`text-primary underline mt-10px ${
                !alwaysVertical && "t:text-18px t:leading-23px"
              }`}
            >
              Learn more
            </div>
          ...
          <div className={`grid grid-cols-2 gap-10px  ${!alwaysVertical && "t:grid-cols-1 t:grid-rows-2 t:gap-10px"}`}>
