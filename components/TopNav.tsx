...
const TopNav: FC<{
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className={`z-50 d:hidden fixed top-0 right-0 bottom-0 w-full max-w-320px bg-white flex-col select-none text-14px leading-18-2px font-medium pb-55px ${className ?? ""}`}>
