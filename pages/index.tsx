      ...
      <div className="">
        ...
        <div className="bg-cream">
          <div className="flex flex-col mx-auto text-center text-18px w-280px
            ...
            <Link href="/about-us">
              <Button type="button" variant="primary" className="mx-auto mt-30px rounded-10pxi">
                Get to know us
              </Button>
            </Link>
          </div>
      ...
      <div className="bg-white
        ...
        >
          ...
          <Link href="/nonprofits">
            <Button className="hidden d:block mx-auto mt-57px rounded-6pxi">Discover more nonprofits</Button>
          </Link>
        </div>
      </div>
