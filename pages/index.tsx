    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <div className="container py-7 flex flex-col md:flex-row mx-auto">
        ...
        <div className="md:flex-1 px-7 flex-none md:order-2 order-1 flex flex-col justify-between">
          <p className="text-48 leading-none">
          ...
          <p className="font-hand text-18 leading-none">
            How you can help move the chain [arrow]
          </p>

          <div className="grid grid-cols-3 gird-rows-3">
            <p className="order-1">Individuals</p>
            <p className="order-4">
              Donate, share and support your favorite nonprofits.
            </p>
            <a className="order-7">Support a cause [arrow]</a>

            <p className="order-2">Nonprofits</p>
            <p className="order-5">Tell your story to raise funds.</p>
            <a className="order-8">Claim your page [arrow]</a>

            <p className="order-3">Corporations</p>
            <p className="order-6">Find nonprofits that need your support.</p>
            <a className="order-9">Sponsor an event [arrow]</a>
          </div>
        </div>
      </div>
      ...
      <div className="container grid grid-rows-2 gap-2  mx-auto text-center">
        <div className="m-50 font-bold text-3xl">What's Move the chain</div>
        <p className="mx-auto text-18" style={{ maxWidth: 800 }}>
      ...
      <div className="container grid grid-rows-3 gap-2 mx-auto text-center my-20">
        <p>
        ...
        <p className="font-bold m-auto text-lg">
          "67% of americans believe social media sites are important for
          creating sustained movements for social change"
        </p>
        <button className="bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-40 mx-20 border border-red-900 rounded">
          Get to know us
        </button>
      </div>
      <div
