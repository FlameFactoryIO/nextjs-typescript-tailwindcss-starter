...
export default function Home() {
  return (
    <div className="w-full min-w-320px">
      ...
      <div className="w-full pt-48px d:pt-77px bg-we-connect-charities-bg-left"
           style={{ backgroundImage: "url('/images/home/hero-background.png')", backgroundRepeat: "no-repeat" }}>
        <div
          id="we-connect-charities"
          className="
            min-w-280px t:min-w-708px d:min-w-1140px t:max-w-708px d:max-w-1140px mx-auto
            pt-36px pl-13px pr-14px pb-40px t:pt-54px t:pb-50px d:pt-21px d:px-120px d:pb-59px
